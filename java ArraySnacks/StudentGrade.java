...
public class StudentGrade {
	...
	public void gradesEntry(int numberOfStudents, int numberOfSubjects) {

		int[][] newArray = new int[numberOfStudents][numberOfSubjects];

		for(int student = 0; student < newArray.length; student++){

			for(int subject = 0; subject < newArray[student].length; subject++) {
				
				System.out.printf("Entering score for student %d%n", student + 1);

				System.out.printf("Enter score for subject %d%n", subject + 1);
				
				newArray[student][subject] = sc.nextInt();
		
				while((newArray[student][subject] < 0) || (newArray[student][subject] > 100)) {
	...
	public int bestGraduatingScore() {
		...
		for(int student = 0; student < studentGrades.length; student++) {
			...
			if (studentGradesTotal(student) > bestGraduatingScore) {

				bestGraduatingScore = studentGradesTotal(student);
	...
	public int bestGraduatingStudent() {
		...
		for(int student = 0; student < studentGrades.length; student++) {
			...
			if(bestGraduatingScore() == studentGradesTotal(student)) {
	...
	public int worstGraduatingScore() {
		...
		int worstGraduatingScore = 300;

		for(int student = 0; student < studentGrades.length; student++) {

			if (studentGradesTotal(student) < worstGraduatingScore) {

				worstGraduatingScore = studentGradesTotal(student);
	...
	public int worstGraduatingStudent() {
		...
		for(int student = 0; student < studentGrades.length; student++) {
			...
			if(worstGraduatingScore() == studentGradesTotal(student)) {
